  ...
  received: function received(data) {
    ...
    for (var i = 0; i < data.content.length; i++) {
      ...
      for (var j = 0; j < headers.length; j++) {
        ...
        console.log("iiiiiiiii", i, "@@@@@@@", data.content[i]);
        console.log("valueeeeeeee", j, " ******** ", data.content[i][headers[j]]);
        td.appendChild(document.createTextNode(data.content[i][headers[j]]));
        tr.appendChild(td);
      }

      console.log("table rowwwwwwww", tr); // $('#container').append(tr);
    }
  }
});
...
/******/ });
//# sourceMappingURL=application-60c0b99cfcc06716590b.js.map